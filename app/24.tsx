...
// 1. BACK TO STANDARD LIBRARY (Run: npm install fhevmjs)
...
// --- ZAMA SEPOLIA V0.9 CONFIGURATION (EXACT VALUES) ---
const ZAMA_CONFIG = {
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.ethereum) {
        ...
        if (accounts.length > 0) {
          ...
          // Attempt FHEVM Init with full config
          try {
    ...
    <div className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-yellow-500 selection:text-black flex flex-col relative">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 flex-grow">
        ...
        {view === 'gallery' && (
          <div className="animate-in fade-in duration-500">
            ...
            {auctions.length === 0 ? (
              <div className="py-20 border border-dashed border-neutral-800 rounded-3xl bg-netral-900/10 text-center relative overflow-hidden">
      ...
      <footer className="border-t border-neutral-800 py-10 mt-12 bg-neutral-900/30">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-sm text-neutral-500 gap-6">
          ...
          <a href="https://x.com/0xshinkai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-all duration-300 group cursor-pointer bg-neutral-800/50 px-4 py-2 rounded-full border border-neutral-700/50 hover:border-yellow-400/0 hover:bg-neutral-800">
            <span>Built by</span>
