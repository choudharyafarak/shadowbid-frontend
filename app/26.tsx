...
// --- ZAMA CONFIGURATION (CORRECTED) ---
const ZAMA_CONFIG = {
  kmsContractAddress: "0xbE0E383937d564D7FF0BC3b46c51f0bF8d5C311A",
  aclContractAddress: "0xf0Ffdc93b7E186bC2f8CB3dAA75D86d1930A433D",
  gatewayUrl: "/zama-gateway", // Proxied to https://gateway.sepolia.zama.ai
  relayerUrl: "https://relayer.testnet.zama.org", // Correct .org domain
};
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.ethereum) {
        ...
        if (accounts.length > 0) {
          ...
          // Init FHEVM using PROXY for Gateway and Direct for Relayer
          try {
            // Use window.location.origin to build the proxy URL dynamically
            const proxyGateway = `${window.location.origin}${ZAMA_CONFIG.gatewayUrl}`;
             ...
             console.warn("Auto-init of FHEVM deferred", e);
          }
        }
      }
    } catch (e) { 
  ...
  const handleBid = async () => {
    ...
    try {
      ...
      if (!instance) {
        ...
        try {
          // Use Proxy URL for Gateway to fix CORS
          const proxyGateway = `${window.location.origin}${ZAMA_CONFIG.gatewayUrl}`;
          ...
          <div className="animate-in fade-in duration-500">
            <div className="text-center mb-16 space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 max-w-4xl mx-auto mt-12 bg-neutral-900/50 border border-neutral-800 rounded-2xl p-6 backdrop-blur-sm">
                ...
                <div className="text-center p-2 border-l border-neutral-800"><p clasName="text-3xl font-bold text-green-400">Online</p><p className="text-xs text-neutral-500 uppercase tracking-wider font-bold mt-1">System Status</p></div>
              </div>
            </div>
      ...
      <footer className="border-t border-neutral-800 py-10 mt-12 bg-neutral-900/30">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-sm text-neutral-500 gap-6">
          <div className="flex items-center gap-8">
            ...
            <a href="https://docs.zama.org" target="_blank" className="hover:text-white transition-colors cursor-ponter font-medium hover:underline">Docs</a>
          </div>
