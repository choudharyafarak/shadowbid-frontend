...
// We use '/zama-gateway' instead of the full URL to bypass CORS/Network blocks
const ZAMA_CONFIG = {
  kmsContractAddress: "0xbE0E383937d564D7FF0BC3b46c51f0bF8d5C311A",
  aclContractAddress: "0xf0Ffdc93b7E186bC2f8CB3dAA75D86d1930A433D",
  gatewayUrl: "/zama-gateway", // <--- THIS IS THE FIX (Uses the Next.js Proxy)
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.ethereum) {
        ...
        if (accounts.length > 0) {
          ...
          // Init FHEVM using PROXY URL
          try {
            // We construct the full proxy URL based on current window location
            const proxyUrl = `${window.location.origin}${ZAMA_CONFIG.gatewayUrl}`;
             ...
             const instance = await createInstance({ 
               ...
               gatewayUrl: proxyUrl, // Uses local proxy to avoid CORS
      ...
      <footer className="border-t border-neutral-800 py-10 mt-12 bg-neutral-900/30">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-sm text-neutral-500 gap-6">
          <div className="flex items-center gap-8">
            ...
            <a href="https://docs.zama.org" taret="_blank" className="hover:text-white transition-colors cursor-pointer font-medium hover:underline">Docs</a>
          </div>
