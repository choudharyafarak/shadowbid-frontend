...
// --- ZAMA SEPOLIA V0.9 CONFIGURATION (CRITICAL FIX) ---
const ZAMA_CONFIG = {
    ...
    try {
      ...
      if (!instance) {
        ...
        try {
          ...
          // This satisfies "EIP1193" (network: window.ethereum) AND "KMS Address"
          ...
          alert(`Security Layer Failed: ${msg}. Check console.`);
          setIsLoading(false);
          return;
        }
      }
            ...
            {auctions.length === 0 ? (
              <div className="py-20 border border-dashed border-neutral-800 rounded-3xl bg-neutral-900/10 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bod text-white mb-2">No Active Auctions</h3>
