          ...
          <div className="animate-in fade-in duration-500">
            ...
            <div className="mt-32 pt-16 border-t border-neutral-800">
              <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                ...
                <a href="https://docs.zama.org" target="_blank" rel="noreferrer" className="text-yellow-400 hover:text-white transition-colors text-sm font-bold flex items-center gap-2 mt-4 md:mt-0 cursor-pointer">Read Documentation <ExternalLink className="w-4 h-4"/></a>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
