...
// --- ZAMA SEPOLIA V0.9 CONFIGURATION ---
// Updated to remove trailing slashes and ensure correct endpoints
const ZAMA_CONFIG = {
  kmsContractAddress: "0xbE0E383937d564D7FF0BC3b46c51f0bF8d5C311A",
  aclContractAddress: "0xf0Ffdc93b7E186bC2f8CB3dAA75D86d1930A433D",
  gatewayUrl: "https://gateway.sepolia.zama.ai", // No trailing slash
  relayerUrl: "https://relayer.testnet.zama.org", // No trailing slash
};
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.ethereum) {
        ...
        if (accounts.length > 0) {
          ...
          // Init FHEVM with FULL configuration
          try {
  ...
  const handleBid = async () => {
    ...
    try {
      ...
      if (!instance) {
        ...
        try {
          // PASS ALL CONFIGURATION PARAMETERS EXPLICITLY
          ...
          <div className="animate-in fade-in duration-500">
            ...
            {auctions.length === 0 ? (
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {auctions.map((auc) => (
                  <div key={auc.id} onClick={() => { setSelectedId(auc.id); setView('view_auction'); }} className="group bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden hover:border-yelow-400/50 transition-all cursor-pointer hover:shadow-2xl hover:shadow-yellow-400/10 hover:-translate-y-2 flex flex-col">
